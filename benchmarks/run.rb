...
# ----- Run benchmarks --------------------------------------------------------
[
  { action: 'ping', category: 'core', warmups: 0,   repetitions: 1000,
    block: Proc.new { |n, runner| runner.runner_client.ping } },
  { action: 'info', category: 'core', warmups: 0,   repetitions: 1000,
    block: Proc.new { |n, runner| runner.runner_client.info } },
  { action: 'get',  category: 'core', warmups: 100, repetitions: 1000,
  ...
  { action: 'index',  category: 'core', warmups: 1, repetitions: 1000,
    setup: Proc.new do |runner|
